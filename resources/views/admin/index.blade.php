        ...
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
                ...
                <span class="fw-semibold d-block mb-1">Dokumen</span>
            ...
            <small class="text-success fw-semibold"> telah diupload</small>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-12 col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title text-nowrap mb-1">13</h3>
            <small class="text-success fw-semibold">Upload hari ini</small>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-6 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
                <span class="d-block mb-1">Tugas Akhir</span>
            </div>
            
            <h3 class="card-title text-nowrap mb-2">154</h3>
      ...
      <div class="col-6 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
                <span class="fw-semibold d-block mb-1">Skripsi</span>
            </div>
            
            <h3 class="card-title mb-2">98</h3>
            <small class="text-success fw-semibold">Dokumen</small>
          </div>
        </div>
      </div>
      <div class="col-6 mb-4">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title mb-2">77</h3>
            <small class="text-success fw-semibold">Dokumen</small>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 mb-4">
        <div class="card">
          <div class="card-body">
            <div class="card-title d-flex align-items-start justify-content-between">
                <span class="fw-semibold d-block mb-1">Disertasi</span>
            </div>
